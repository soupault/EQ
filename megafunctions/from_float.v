...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="FLOAT2INT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=11 WIDTH_EXP_OUTPUT=8 WIDTH_INT=24 WIDTH_MAN_INPUT=52 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=24 aclr clock dataa overflow result underflow
//VERSION_BEGIN 12.1 cbx_altbarrel_shift 2012:11:07:18:22:15:SJ cbx_altfp_convert 2012:11:07:18:22:15:SJ cbx_altpriority_encoder 2012:11:07:18:22:16:SJ cbx_altsyncram 2012:11:07:18:22:16:SJ cbx_cycloneii 2012:11:07:18:22:16:SJ cbx_lpm_abs 2012:11:07:18:22:16:SJ cbx_lpm_add_sub 2012:11:07:18:22:16:SJ cbx_lpm_compare 2012:11:07:18:22:16:SJ cbx_lpm_decode 2012:11:07:18:22:16:SJ cbx_lpm_divide 2012:11:07:18:22:16:SJ cbx_lpm_mux 2012:11:07:18:22:16:SJ cbx_mgl 2012:11:07:18:24:04:SJ cbx_stratix 2012:11:07:18:22:16:SJ cbx_stratixii 2012:11:07:18:22:16:SJ cbx_stratixiii 2012:11:07:18:22:16:SJ cbx_stratixv 2012:11:07:18:22:16:SJ cbx_util_mgl 2012:11:07:18:22:16:SJ  VERSION_END
// synthesis VERILOG_INPUT_VERSION VERILOG_2001
// altera message_off 10463



//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=75 WIDTHDIST=7 aclr clk_en clock data distance result
...
module  from_float_altbarrel_shift_60g
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	reg	[1:0]	dir_pipe;
	reg	[74:0]	sbit_piper1d;
	reg	[74:0]	sbit_piper2d;
	reg	sel_pipec4r1d;
	reg	sel_pipec5r1d;
	reg	sel_pipec6r1d;
	wire  [7:0]  dir_w;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper1d <= 75'b0;
		else if  (clk_en == 1'b1)   sbit_piper1d <= smux_w[299:225];
	// synopsys translate_off
	initial
		sbit_piper2d = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sbit_piper2d <= 75'b0;
		else if  (clk_en == 1'b1)   sbit_piper2d <= smux_w[524:450];
	// synopsys translate_off
	initial
		sel_pipec4r1d = 0;
	// synopsys translate_on
	...
	assign
		...
		direction_w = 1'b0,
		pad_w = {64{1'b0}},
		result = sbit_w[599:525],
		sbit_w = {sbit_piper2d, smux_w[449:300], sbit_piper1d, smux_w[224:0], data},
		sel_w = {sel_pipec6r1d, sel_pipec5r1d, sel_pipec4r1d, distance[3:0]},
		smux_w = {((({75{(sel_w[6] & (~ dir_w[6]))}} & {sbit_w[460:450], pad_w[63:0]}) | ({75{(sel_w[6] & dir_w[6])}} & {pad_w[63:0], sbit_w[524:514]})) | ({75{(~ sel_w[6])}} & sbit_w[524:450])), ((({75{(sel_w[5] & (~ dir_w[5]))}} & {sbit_w[417:375], pad_w[31:0]}) | ({75{(sel_w[5] & dir_w[5])}} & {pad_w[31:0], sbit_w[449:407]})) | ({75{(~ sel_w[5])}} & sbit_w[449:375])), ((({75{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[358:300], pad_w[15:0]}) | ({75{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[374:316]})) | ({75{(~ sel_w[4])}} & sbit_w[374:300])), ((({75{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[291:225], pad_w[7:0]}) | ({75{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[299:233]})) | ({75{(~ sel_w[3])}} & sbit_w[299:225])), ((({75{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[220:150], pad_w[3:0]}) | ({75{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[224:154]})) | ({75{(~ sel_w[2])}} & sbit_w[224:150])), ((({75{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[147:75], pad_w[1:0]}) | ({75{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[149:77]})) | ({75{(~ sel_w[1])}} & sbit_w[149:75])), ((({75{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[73:0], pad_w[0]}) | ({75{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[74:1]})) | ({75{(~ sel_w[0])}} & sbit_w[74:0]))};
endmodule //from_float_altbarrel_shift_60g

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 371 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  from_float_altfp_convert_kdp
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	wire  [74:0]   wire_altbarrel_shift6_result;
	...
	reg	int_or_reg2;
	reg	int_or_reg3;
	reg	[23:0]	integer_result_reg;
	reg	[22:0]	integer_rounded_reg;
	...
	wire  [22:0]   wire_add_sub7_result;
	wire  wire_add_sub8_cout;
	wire  [10:0]   wire_add_sub8_result;
	...
	wire  add_1_cout_w;
	wire  add_1_w;
	wire  [23:0]  all_zeroes_w;
	wire  [74:0]  barrel_mantissa_input;
	wire  [21:0]  barrel_zero_padding_w;
	wire  below_limit_exceeders;
	wire  [23:0]  below_limit_integer;
	...
	wire  [23:0]  exceed_limit_integer;
	...
	wire  [23:0]  infinity_value_w;
	wire  int_or1_w;
	wire  [23:0]  integer_output;
	wire  [22:0]  integer_post_round;
	wire  [22:0]  integer_pre_round;
	wire  [23:0]  integer_result;
	wire  [22:0]  integer_rounded;
	wire  [22:0]  integer_rounded_tmp;
	wire  [22:0]  integer_tmp_output;
	wire  [10:0]  inv_add_1_adder1_w;
	wire  [11:0]  inv_add_1_adder2_w;
	wire  [22:0]  inv_integer;
	wire  [74:0]  lbarrel_shift_result_w;
	wire  [22:0]  lbarrel_shift_w;
	wire  lower_limit_selector;
	wire  lowest_integer_selector;
	wire  [22:0]  lowest_integer_value;
	wire  [25:0]  man_bus1;
	wire  [25:0]  man_bus2;
	wire  [25:0]  man_or1;
	wire  man_or1_w;
	...
	wire  nan_input_w;
	wire  [23:0]  neg_infi_w;
	wire  [10:0]  padded_exponent_input;
	wire  [23:0]  pos_infi_w;
	wire  [6:0]  power2_value_w;
	wire  [23:0]  result_w;
	wire  round_bit_w;
	wire  sign_input;
	wire  sign_input_w;
	wire  [22:0]  signed_integer;
	wire  sticky_bit_w;
	wire  [50:0]  sticky_bus;
	wire  [50:0]  sticky_or;
	wire  [22:0]  unsigned_integer;
	wire  upper_limit_w;
	wire  zero_input_w;

	from_float_altbarrel_shift_60g   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) integer_result_reg <= 24'b0;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) integer_rounded_reg <= 23'b0;
	...
	assign
		...
		all_zeroes_w = {1'b0, {23{1'b0}}},
		barrel_mantissa_input = {barrel_zero_padding_w, implied_mantissa_input},
		barrel_zero_padding_w = {22{1'b0}},
		below_limit_exceeders = (((denormal_input_w | zero_input_w) | lower_limit_selector) | nan_input_w),
		below_limit_integer = (({24{(~ below_limit_exceeders)}} & integer_output) | ({24{below_limit_exceeders}} & all_zeroes_w)),
		...
		clk_en = 1'b1,
		const_bias_value_add_width_res_w = 11'b10000010110,
		...
		exceed_limit_integer = (({24{(~ exceed_limit_exceeders)}} & below_limit_integer) | ({24{exceed_limit_exceeders}} & infinity_value_w)),
		...
		infinity_value_w = (({24{(~ sign_input_w)}} & pos_infi_w) | ({24{sign_input_w}} & neg_infi_w)),
		int_or1_w = man_or2[3],
		...
		integer_rounded = (({23{(~ lowest_integer_selector)}} & integer_rounded_tmp) | ({23{lowest_integer_selector}} & lowest_integer_value)),
		integer_rounded_tmp = (({23{(~ add_1_w)}} & integer_pre_round) | ({23{add_1_w}} & integer_post_round)),
		integer_tmp_output = (({23{(~ sign_input_w)}} & unsigned_integer) | ({23{sign_input_w}} & signed_integer)),
		inv_add_1_adder1_w = wire_add_sub8_result,
		inv_add_1_adder2_w = (({12{(~ wire_add_sub8_cout)}} & inv_integer[22:11]) | ({12{wire_add_sub8_cout}} & wire_add_sub9_result)),
		inv_integer = (~ integer_rounded_reg),
		lbarrel_shift_result_w = wire_altbarrel_shift6_result,
		lbarrel_shift_w = lbarrel_shift_result_w[74:52],
...
endmodule //from_float_altfp_convert_kdp
//VALID FILE
...
module from_float (
	...
	wire [23:0] result = sub_wire2[23:0];

	from_float_altfp_convert_kdp	from_float_altfp_convert_kdp_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.overflow (sub_wire0),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL from_float.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL from_float.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL from_float.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL from_float_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL from_float_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL from_float.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL from_float.cmp FALSE TRUE
