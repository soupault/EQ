...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=24 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=11 WIDTH_INT=24 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=52 WIDTH_RESULT=64 aclr clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone IV E" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=24 WIDTHDIST=5 aclr clk_en clock data distance result
...
module  to_float_altbarrel_shift_uvf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //to_float_altbarrel_shift_uvf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  to_float_altpriority_encoder_3v7
	( 
	data,
	q) ;
	input   [1:0]  data;
	...
	assign
		q = {data[1]};
endmodule //to_float_altpriority_encoder_3v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  to_float_altpriority_encoder_3e8
	( 
	data,
	q,
	zero) ;
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //to_float_altpriority_encoder_3e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  to_float_altpriority_encoder_6v7
	( 
	data,
	q) ;
	input   [3:0]  data;
	...
	to_float_altpriority_encoder_3v7   altpriority_encoder12
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder12_q));
	to_float_altpriority_encoder_3e8   altpriority_encoder13
	( 
	.data(data[3:2]),
...
endmodule //to_float_altpriority_encoder_6v7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  to_float_altpriority_encoder_6e8
	( 
	data,
	q,
	zero) ;
	...
	to_float_altpriority_encoder_3e8   altpriority_encoder14
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder14_q),
	.zero(wire_altpriority_encoder14_zero));
	to_float_altpriority_encoder_3e8   altpriority_encoder15
	( 
	.data(data[3:2]),
...
endmodule //to_float_altpriority_encoder_6e8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  to_float_altpriority_encoder_bv7
	( 
	data,
	q) ;
	input   [7:0]  data;
	...
	to_float_altpriority_encoder_6v7   altpriority_encoder10
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder10_q));
	to_float_altpriority_encoder_6e8   altpriority_encoder11
	( 
	.data(data[7:4]),
...
endmodule //to_float_altpriority_encoder_bv7
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  to_float_altpriority_encoder_be8
	( 
	data,
	q,
	zero) ;
	...
	to_float_altpriority_encoder_6e8   altpriority_encoder16
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder16_q),
	.zero(wire_altpriority_encoder16_zero));
	to_float_altpriority_encoder_6e8   altpriority_encoder17
	( 
	.data(data[7:4]),
...
endmodule //to_float_altpriority_encoder_be8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  to_float_altpriority_encoder_r08
	( 
	data,
	q) ;
	input   [15:0]  data;
	...
	to_float_altpriority_encoder_bv7   altpriority_encoder8
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder8_q));
	to_float_altpriority_encoder_be8   altpriority_encoder9
	( 
	.data(data[15:8]),
...
endmodule //to_float_altpriority_encoder_r08
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  to_float_altpriority_encoder_rf8
	( 
	data,
	q,
	zero) ;
	...
	to_float_altpriority_encoder_be8   altpriority_encoder18
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder18_q),
	.zero(wire_altpriority_encoder18_zero));
	to_float_altpriority_encoder_be8   altpriority_encoder19
	( 
	.data(data[15:8]),
...
endmodule //to_float_altpriority_encoder_rf8

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  to_float_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	to_float_altpriority_encoder_r08   altpriority_encoder6
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder6_q));
	to_float_altpriority_encoder_rf8   altpriority_encoder7
	( 
	.data(data[31:16]),
...
endmodule //to_float_altpriority_encoder_qb6

//synthesis_resources = lpm_add_sub 2 lpm_compare 1 reg 258 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  to_float_altfp_convert_ahn
	( 
	aclr,
	clock,
	dataa,
...
`endif
	...
	wire  [23:0]   wire_altbarrel_shift5_result;
	...
	to_float_altbarrel_shift_uvf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	to_float_altpriority_encoder_qb6   altpriority_encoder2
	( 
	...
	assign
		...
		clk_en = 1'b1,
		const_bias_value_add_width_int_w = 11'b10000010101,
...
module to_float (
	...
	to_float_altfp_convert_ahn	to_float_altfp_convert_ahn_component (
				.aclr (aclr),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL to_float.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL to_float.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL to_float.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL to_float_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL to_float_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL to_float.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL to_float.cmp FALSE TRUE
