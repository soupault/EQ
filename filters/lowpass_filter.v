...
// Generated on: 2013-12-24 19:40:21
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: lowpass_filter
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  parameter coeff1 = -1.1914164255090629E-02; //double
  parameter coeff2 = -5.0815291485891874E-02; //double
  parameter coeff3 = -1.2157348549853128E-01; //double
  parameter coeff4 = -2.0033960385596461E-01; //double
  parameter coeff5 = -2.3478762601644962E-01; //double
  parameter coeff6 = -1.7712287531191190E-01; //double
  parameter coeff7 = -2.8967738864476518E-02; //double
  parameter coeff8 = 1.4186050940482753E-01; //double
  parameter coeff9 = 2.4016770909643792E-01; //double
  parameter coeff10 = 2.1447320337235568E-01; //double
  parameter coeff11 = 1.0106932053482975E-01; //double
  parameter coeff12 = -3.2497899635618587E-03; //double
  parameter coeff13 = -2.0742177912133654E-02; //double
  parameter coeff14 = 4.4926406442926232E-02; //double
  parameter coeff15 = 1.1987282756481298E-01; //double
  parameter coeff16 = 1.3214129235820732E-01; //double
  parameter coeff17 = 7.6229497885340378E-02; //double
  parameter coeff18 = 1.0138218888095336E-02; //double
  parameter coeff19 = -5.8770831172758149E-03; //double
  parameter coeff20 = 3.3688858411634173E-02; //double
  parameter coeff21 = 8.0840396552385146E-02; //double
  parameter coeff22 = 8.6021694477491792E-02; //double
  parameter coeff23 = 4.5525918422731293E-02; //double
  parameter coeff24 = -1.4333630413108304E-04; //double
  parameter coeff25 = -8.6561126914386395E-03; //double
  parameter coeff26 = 2.5535251914295815E-02; //double
  parameter coeff27 = 7.1702500066813252E-02; //double
  parameter coeff28 = 9.4108239861447229E-02; //double
  parameter coeff29 = 8.1578363355023609E-02; //double
  parameter coeff30 = 4.8865547491731803E-02; //double
  parameter coeff31 = 1.9441777129973480E-02; //double
  parameter coeff32 = 2.8715640583496997E-03; //double

  // Signals
  real delay_pipeline [0:31] ; // double
  ...
  always @* sum1_1 <= product32 + product31;

  always @* sum1_2 <= product30 + product29;

  always @* sum1_3 <= product28 + product27;

  always @* sum1_4 <= product26 + product25;

  always @* sum1_5 <= product24 + product23;

  always @* sum1_6 <= product22 + product21;

  always @* sum1_7 <= product20 + product19;

  always @* sum1_8 <= product18 + product17;

  always @* sum1_9 <= product16 + product15;

  always @* sum1_10 <= product14 + product13;

  always @* sum1_11 <= product12 + product11;

  always @* sum1_12 <= product10 + product9;

  always @* sum1_13 <= product8 + product7;

  always @* sum1_14 <= product6 + product5;

  always @* sum1_15 <= product4 + product3;

  always @* sum1_16 <= product2 + product1;
